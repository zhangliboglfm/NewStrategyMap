...
<link rel="stylesheet" href="css/analysis/analysis.css" type="text/css"></link>
...
<script type="text/javascript" src="js/jsp/zlb.analysis.fn.js"></script>
...
<body>
	<div class="main"> 
		...
		<div class="myAnalysis">
			<div class="title">我的分析</div>
			<div id="analyContent" class="analyContent">
				<div class="oneAnaly">
					<div class="divOrder">1</div>
					<div class="divAnalyName">VOLTE终端用户</div>
					<div class="divEdit"><i class="iconfont">&#xe624;</i>&nbsp;编辑</div>
					<div class="divClear"><i class="iconfont">&#xe618;</i>&nbsp;删除</div>
				</div>
				<div class="oneAnaly">
					<div class="divOrder">2</div>
					<div class="divAnalyName">4G用户</div>
					<div class="divEdit"><i class="iconfont">&#xe624;</i>&nbsp;编辑</div>
					<div class="divClear"><i class="iconfont">&#xe618;</i>&nbsp;删除</div>
				</div>
				<div class="oneAnaly">
					<div class="divOrder">3</div>
					<div class="divAnalyName">家宽用户</div>
					<div class="divEdit"><i class="iconfont">&#xe624;</i>&nbsp;编辑</div>
					<div class="divClear"><i class="iconfont">&#xe618;</i>&nbsp;删除</div>
				</div>
			</div>
...
<script>
	...
	$(function(){
		...
		$("#divParentNav,#analyContent").niceScroll({
		...
		$("#divRegion").miapRegion({
			...
			"clickfn":function(data){
				/* alert(data.regionLvl+":"+data.regionId); */
			}
		});
