...
.x .axis g.tick text,.y .axis g.tick text{font-size: 16px;}
.axis path, .axis line {
  fill: none;
  stroke: #fff;
...
<body>
	<div id="chart" style="margin-top: 30px;margin-left:30px;"></div>
	<div class="baseinfo" onclick="tochangepage1()"><span>返回4G套餐信息</span></div>
...
<script type="text/javascript">
	...
	var radiusScale = d3.scale.sqrt().domain([0, 600000]).range([0, 50]);
	...
	function tochangepage1(){
		window.parent.tochangepage1(0);
	}
</script>
</html>
