    ...
    function flyclass(){
         $.ajax({
			    ...
			    oulinepolarother("divPackChart8",data["fxtc8y"]);
	  			...
	  			oulinepolarother("divPackChart48",data["fxtc48y"]);
	  			...
	  			oulinepolarother("divPackChart158",data["fxtc158y"]);
	  			oulinepolarother("divPackChart238",data["fxtc238y"]);
	  			oulinepolarother("divPackChart268",data["fxtc268y"]);
	  			oulinepolarother("divPackChart338",data["fxtc338y"]);
	  			oulinepolarother("divPackChart588",data["fxtc588y"]);
