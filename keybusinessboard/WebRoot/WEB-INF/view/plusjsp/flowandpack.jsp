...
<script type="text/javascript" src="js/echartsplus-zlbpack.js"></script>
<script type="text/javascript" src="js/d3.min.js"></script>
<script type="text/javascript" src="js/velocity.min.js"></script>
<script type="text/javascript" src="js/velocity.ui.js"></script>

<link rel="stylesheet" href="css/flowandpackplus/flowandpack.css" type="text/css"></link>
<link rel="stylesheet" href="css/iconfont/iconfont.css" type="text/css"></link><style>

@font-face {font-family: "iconfont";
  src: url('iconfont.eot?t=1501727281079'); /* IE9*/
  src: url('iconfont.eot?t=1501727281079#iefix') format('embedded-opentype'), /* IE6-IE8 */
  url('iconfont.woff?t=1501727281079') format('woff'), /* chrome, firefox */
  url('iconfont.ttf?t=1501727281079') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+*/
  url('iconfont.svg?t=1501727281079#iconfont') format('svg'); /* iOS 4.1- */
}
	...
	<div class="flowandpack">
		<div class="top">
			...
			<div class="packMainPush">
				<!-- 标题部分 -->
				<div class="flowTopBack">
						<div class="divTitle"><span>主推流量包</span></div> 
				</div>
				<!-- 数据部分 -->
				...
				<!-- <div class="mainPushName" id="mainPushName">
		...
		<div class="bottom">
			<!-- 标题部分 -->
			<div class="flowTopBack">
						<div class="divTitle"><span>流量包线下办理情况</span></div>
...
<script type="text/javascript">
	...
	var radiusScale = d3.scale.sqrt().domain([0, 2000]).range([0, divheight]);//构建一个平方根比例尺
