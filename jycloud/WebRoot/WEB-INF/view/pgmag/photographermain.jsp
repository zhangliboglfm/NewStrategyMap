...
<link rel="stylesheet" href="css/photographermain.css" type="text/css"></link>
...
<script type="text/javascript" src="js/photographermain.js"></script>
<style type="text/css">
...
<body>
	<div class="maindiv">
		<div class="line">摄影家简介<i class="iconfont" title="修改" onclick="openUpdate()">&#xe62c;</i></div>
		<div class="top">
			<div class="info">
				<div class="imgdiv">
				...
				<div class="infodiv">
					...
					<ul style="height: auto;width:auto">
						<li><div class="ezchinfodiv"><div class="lb">性别:</div><input id="iptPgSex" type="text" name="pginfo" value="" readonly="readonly" onblur="checkSex(this)"/></div></li>
						...
						<li><div class="ezchinfodiv"><div class="lb">审核状态:</div><input id="iptPgAuditState" type="text" name="pginfo" value="" readonly="readonly"/></div></li>
			...
			<div class="layui-tab">
				...
				<div class="layui-tab-content">
					<div class="layui-tab-item layui-show">
						<iframe id="ifrStandardImg" src="pgstandardimg.do?pId=<%=request.getAttribute("pId")%>"></iframe>
					</div>
					<div class="layui-tab-item">
						<iframe id="ifrLifeTime" src="pglifetime.do?pId=<%=request.getAttribute("pId")%>"></iframe>
					</div>
					<div class="layui-tab-item">
						<iframe id="ifrAchievement" src="pgachievement.do?pId=<%=request.getAttribute("pId")%>"></iframe>
					</div>
					<div class="layui-tab-item">
						<iframe id="ifrStyle" src="pgstyle.do?pId=<%=request.getAttribute("pId")%>"></iframe>
					</div>
					<div class="layui-tab-item">
						<iframe id="ifrWorks" src="pgworks.do?pId=<%=request.getAttribute("pId")%>"></iframe>
					</div>
					<div class="layui-tab-item">
						<iframe id="ifrRelevantArticle" src="relateArticle.do?photogId=<%=request.getAttribute("pId")%>"></iframe>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="divHandle" class="handlediv" align="center">
		<button class="layui-btn" onclick="saveNewPgInfo()">保存</button>
		<button class="layui-btn" onclick="cancelUpdate()">取消</button>
	</div>
</body>
