...
<html>
  ...
  <script type="text/javascript">
	...
	function loadphotoglist(currPage,pageSize){
		...
		var url="selphotoglistaudit.do";
		//var parameter={"importdate":importDate,"pgName":pgName,"currPage":currPage,"pageSize":pageSize};
		var parameter={"auditStatus":auditStatus,"pgName":pgName,"currPage":currPage,"pageSize":pageSize};
		ajaxRequest(url, parameter, function(data){
			...
			for(var i=0;i<dataList.length;i++){
	    		...
	    		html+='	<div class="cmdlist-container" pgid="'+id+'" onmouseover="shadowover(this)" onmouseout="shadowout(this)" onclick="photogClick(this)">';
	...
	function photogClick(obj){
		...
		data={
			"title":"摄影家详情",
			"lay-id":layid,
			"src":"photographermain.do?pId="+pgid
		};
