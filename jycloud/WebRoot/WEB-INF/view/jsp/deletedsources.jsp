...
<html>
    		...
    		<div id="statepic" style="width:100%;height:95%;text-align: center">
    			...
    			<div class="state3" style="height:100%;width:39%;border-left: 1px solid;">
    				...
    				<div style="text-align: center;height:40%;width:100%;">
    					<div class="state5"><button class="layui-btn layui-btn-sm layui-btn-normal">保存</button></div>
    					<div class="state5"><button class="layui-btn layui-btn-sm layui-btn-normal">保存并筛选</button></div>
    				</div>
    			</div> -->
    		</div>
    	</div>
    	...
    	<div class="content">
    		...
    		<div class="content2" id="cts" style="width:100%;height:75%;border-bottom: 1px solid black;overflow: hidden;display: none;">
    			...
    			<div id="imginfo">
    				...
    				<div style="text-align: center;height:40%;width:100%;margin-top: 25px;">
    					<div class="state5"><button class="layui-btn layui-btn-sm layui-btn-normal savepic">保存</button></div>
    					<div class="state5"><button class="layui-btn layui-btn-sm layui-btn-normal deletepic">删除</button></div>
    		...
    		<div class="content2" id="ct3" style="width:100%;height:13%;">
    			<div class="content3" style="width:100%;height:100%">
    				...
    				<div class="content4 buff" style="width:40%;text-align: center;"><button class="layui-btn layui-btn-sm layui-btn-normal" onclick="recoverys()">恢复</button></div>
    			</div>
    		</div>
    	</div>
    </div>
  ...
  <script type="text/javascript">
	...
	function seeedit(id){
		...
		w3+="</div>"; 
		w3+="<div class='sedit'>";
		w3+="<div class='state5'><button class='layui-btn layui-btn-sm layui-btn-normal buttonedit' id='"+id+"' onclick='recoveryPic(this)'>恢复</button></div>";
...
/* 		w3+="<div><button class='layui-btn layui-btn-sm layui-btn-normal ' id='"+id+"' onclick='screenpics(this)'>保存并筛选</button></div>"; */
	...
	function see(obj){
		...
		layer.open({
	        ...
	        ,content: 'deletesourcesaudit.do?id='+id
	        ,btn: ['恢复', '取消']
    		...
    		//按钮【按钮一】的回调
    			recoveryPic2(data[0].SAMP_PIC_ID);
    			layer.close(index);
		...
		w+="<div class='state5'><button class='layui-btn layui-btn-sm layui-btn-normal buttonedit' onclick='recoveryPic2(this)' id='"+data[0].SAMP_PIC_ID+"'>恢复</button></div>";
		w+="</div>";
		w+="</div>";
		$("#statepic").html("");
		$("#statepic").html(w);
