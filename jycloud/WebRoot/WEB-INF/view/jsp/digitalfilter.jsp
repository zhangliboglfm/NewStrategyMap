...
<html>
  ...
  <body>
    ...
    <!-- <div id="picmanage" style="height:575px;width:1165px;"> -->
    	...
    	<!-- <div class="screen">
    		<div class="screen2">
    			<div class="screen3">
    				<div class="screen4">&nbsp爬取日期 :</div>
    				<div class="screen4">
    					<input id="test1" type="text" class="layui-input" style="height:65%;width:75%;" placeholder="全部" />
    				</div>
    			</div>
    			<div class="screen3">
    				<div class="screen4">关键字 :</div>
    				<div class="screen4">
    					<input id="crux"  value="">
    				</div>
    			</div>
    		...
    		<div class="screen2">
    			<div class="screen3" style="width:100%">
    				<div class="screen4">&nbsp颜色类型 :</div>
	    			<div class="screen4">
	    				<form class='layui-form' action='' lay-filter='example'>
			    			<input id=r1 type="radio"  name="color" title="全部" checked="checked">
			    			<input id=r2 type="radio"  name="color" title="彩色" >
    		...
    		<div class="screen2">
    			<div class="screen3" style="width:100%">
    				<div class="screen4">&nbsp胶片型号 :</div>
    				<div class="screen4">
	    				<form class='layui-form' action='' lay-filter='example'>
		    				<input id=f1 type="radio" name="film" title='全部' checked="checked">
		    				<input id=f2 type="radio" name="film" title='自定义 :'>
    				...
    				<div class="screen4"><input id="film"/></div>
    				<div class="screen4"><button id="filmb" class="layui-btn layui-btn-sm layui-btn-normal" onclick="more(id)">更多</button></div>
    			</div>
    		</div>
    		<div class="screen2">
    			<div class="screen3" style="width:100%">
    				<div class="screen4">&nbsp照片尺寸 :</div>
    				<div class="screen4">
    					<form class='layui-form' action='' lay-filter='example'>
	    					<input id=s1 type="radio"  name="size" title='全部' checked="checked">
	    					<input id=s2 type="radio"  name="size" title='自定义 :'>
	    			...
	    			<div class="screen4">短边长: <input class="size" id="long" value="" /></div>
	    			<div class="screen4 layui-btn layui-btn-primary layui-btn-sm" style="width:7%;padding:0 0;" onclick="switchbt()">
		    			<div id="less" class="bsbutton" style="background-color: #009688;">≤</div>
		    			<div id="greater" class="bsbutton">≥</div>
	    			</div>
    			</div>
    		...
    		<div class="screen2">
    			<div class="screen3" style="width:100%">
    				<div class="screen4">&nbsp标签类型 :</div>
    				<div id="Label" class="screen4">
	    				<div class="screen4"><input type="checkbox" value="风景" name="label">风景</div>
	    				<div class="screen4"><input type="checkbox" value="黑白" name="label">黑白</div>
	    				<div class="screen4"><input type="checkbox" value="人文" name="label">人文</div>
    				</div>
    		...
    		<div class="screen2">
    			<div class="screen3" style="width:100%">
    				<div class="screen4">&nbsp相机型号 :</div>
    				<div class="screen4">
    					<form class='layui-form' action='' lay-filter='example'>
	    					<input id=c1 type="radio" name="camera" checked="checked" title='全部'>
	    					<input id=c2 type="radio" name="camera" title='自定义 :'>
    				...
    				<div class="screen4"><input id="camera"/></div>
    				<div class="screen4"><button id="camerab" class="layui-btn layui-btn-sm layui-btn-normal" onclick="more(id)">更多</button></div>
    			</div>
    		</div>
    		<div class="screen2">
    			<div class="screen3" style="width:100%">
    				<div class="screen4">&nbsp镜头型号 :</div>
    				<div class="screen4">
    					<form class='layui-form' action='' lay-filter='example'>
	    					<input id=le1 type="radio" name="lens" checked="checked" title='全部'>
	    					<input id=le2 type="radio" name="lens" title='自定义 :'>
    				...
    				<div class="screen4"><input id="lens"/></div>
    				<div class="screen4"><button id="lensb" class="layui-btn layui-btn-sm layui-btn-normal" onclick="more(id)">更多</button></div>
    			</div>
    		</div>
    		<div class="screens" style="width:100%;height:14%;">
    			<div class="screen3" style="width:100%;height:100%;text-align:center">
    	...
    	<div class="content">
    		...
    		<div class="content2" id="ct3" style="width:100%;height:13%;">
    			<div class="content3" style="width:100%;height:100%">
    				...
    				<div class="content4 buff" style="width:20%;text-align: right;"><button class="layui-btn layui-btn-sm layui-btn-normal" onclick="screened()">已筛选</button></div>
    				<div class="content4 buff" style="width:20%;text-align: center;"><button class="layui-btn layui-btn-sm layui-btn-normal"onclick="deletes()">删除</button></div>
    			</div>
    		</div>
    	</div>
    </div>
  ...
  <script type="text/javascript">
	...
	function seeedit(id){
		...
		w3+="</div>"; 
		w3+="<div class='sedit'>";
		w3+="<div class='state4'><button class='layui-btn layui-btn-sm layui-btn-normal buttonedit' id='"+id+"' onclick='savepic(this)'>保存</button></div>";
		w3+="<div class='state4'><button class='layui-btn layui-btn-sm layui-btn-normal buttonedit' id='"+id+"' onclick='deletepics(this)'>删除</button></div>";
...
/* 		w3+="<div><button class='layui-btn layui-btn-sm layui-btn-normal ' id='"+id+"' onclick='screenpics(this)'>保存并筛选</button></div>"; */
	...
	function see(obj){
		...
		if(data[0].IS_BLACK=="1"){
			w+="<tr><td>是否黑白:</td><td><div style='height:100%;width:100%;'><form id='isblack' class='layui-form' action='' lay-filter='example'><input type='checkbox' name='isblack' lay-skin='switch' lay-text='彩色|黑白'></form></div></td></tr>";
		}else{
			w+="<tr><td>是否黑白:</td><td><div style='height:100%;width:100%;'><form id='isblack' class='layui-form' action='' lay-filter='example'><input type='checkbox' name='isblack' lay-skin='switch' lay-text='彩色|黑白' checked></form></div></td></tr>";
		}
		w+="<tr><td>相机型号:</td><td><input id='inputcamera2' type='text' value='"+data[0].FILM_CAMERA_ID+"'/></td></tr>";
		w+="<tr><td>胶片型号:</td><td><input id='inputfilm2' type='text' value='"+data[0].FILM_PROD_ID+"'/></td></tr>";
		w+="<tr><td>镜头类型:</td><td><input id='inputlens2' type='text' value='"+data[0].LENS_ID+"'/></td></tr>";
		w+="<tr><td>回退原因:</td><td>暂无</td></tr>";
		w+="</table>";
		...
		w+="<div class='state4'><button class='layui-btn layui-btn-sm layui-btn-normal buttonedit' onclick='savepic2(this)' id='"+data[0].SAMP_PIC_ID+"'>保存</button></div>";
		w+="<div class='state4'><button class='layui-btn layui-btn-sm layui-btn-normal buttonedit' onclick='close2()' id='"+data[0].SAMP_PIC_ID+"'>取消</button></div>";
		w+="</div>";
		w+="</div>";
		$("#statepic").html("");
		$("#statepic").html(w);
