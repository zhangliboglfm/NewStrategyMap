    ...
    <!-- <div id="picmanage" style="height:575px;width:1165px;"> -->
    	...
    	<div id="more">
    		...
    		<div style="width:100%;height:20%;text-align: center;">
    			<button id="enter" class="layui-btn layui-btn-xs layui-btn-normal"  style="height: 32px;width: 50px">确认</button>
    		</div>
    	</div>
    	<div class="screen">
    		<div class="screen2">
    	...
    	<div class="content">
    		<div class="content2" id="ct1" style="width:100%;height:12%;margin-top:3px;border-bottom: 1px solid black;">
    			...
    			<div class="content3" style="height:100%;width:76%;">
    				...
    				<button id="pattern2" class="layui-btn layui-btn-sm layui-btn-normal pattern" style="width:80.6px;display: none;margin-left: 0px;">筛选模式</button>
    			</div>
  ...
  <script type="text/javascript">
	...
	function more(id){
		...
		layer.open({
	        ...
	        ,content: 'filmmore.do?id='+id
	        ,btn: ['确认', '取消']
	        ,zIndex: layer.zIndex //重点1
	        ,success: function(layero){
	          //layer.setTop(layero); //重点2
	          	layero.find('.layui-layer-btn').css('text-align', 'center');
	          	layero.find('.layui-layer-btn0').attr('text-align', 'center');
	        }
	        ,yes: function(index, layero){
    		//按钮【按钮一】的回调
    			var str = $(layero).find("iframe")[0].contentWindow.getstrenter();
    			filmmoreenter(str);
    			layer.close(index);
	...
	//编辑模式点击图片展示内容
	function seeedit(id){
		$(".lidiv").css("background-color","#FFFFFF");
	...
	function see(obj){
		...
		//var data=getOnePic(id);
		/* var w="";
		w+="<div class='state3' style='height:100%;width:60%;display: table-cell;vertical-align: middle;text-align: center;'><img style='height:90%;width:90%;' src='SpiderImg/"+data[0].SAMP_PIC_SRC+"'></div>";
		...
		if(data[0].IS_BLACK=="1"){
			w+="<tr><td>是否黑白:</td><td><div style='height:100%;width:100%;display:inline;'><form id='isblack' class='layui-form' action='' lay-filter='example' style='display:inline;'><input type='checkbox' name='isblack' lay-skin='switch' lay-text='彩色|黑白'></form></div></td></tr>";
		}else{
			w+="<tr><td>是否黑白:</td><td><div style='height:100%;width:100%;display:inline;'><form id='isblack' class='layui-form' action='' lay-filter='example' style='display:inline;'><input type='checkbox' name='isblack' lay-skin='switch' lay-text='彩色|黑白' checked></form></div></td></tr>";
		}
