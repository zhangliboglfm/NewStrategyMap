	...
	function showArtInfo(e) {
        ...
        layui.use(['layer','form'], function(){
	        ...
	        layer.open({
		        ...
		        ,maxmin: true
		        ,offset: 'auto'
		        ,content: 'cgArtDetail.do?articleId='+articleId+'&cgName='+encodeURI(encodeURI(cgName))+'&auditStatus='+cur_auditstatus
