...
<html>
  ...
  <style type="text/css">
  		...
  		.deletePhotog{
			position:absolute;right:10px;top:1%;
			text-align:center;
		}
		.deletePhotog2{
     ...
     <div id="" class="layui-layer-content">
		 <form class="layui-form" action="" lay-filter="example">
		  <div class="layui-form-item layui-row" style="margin-left:3%">
		    ...
		    <div id="checkbox">
			   <!--    <input type="checkbox" name="simple" lay-skin="primary" title="原因1">	
			      <input type="checkbox" name="simple" lay-skin="primary" title="原因2">	
			      <input type="checkbox" name="simple" lay-skin="primary" title="原因3"> -->
			</div>
		    ...
		    <div class="layui-input-block deletePhotog2">
		      <button  id="btn1" class="layui-btn" lay-submit="" onclick="reject(this)" lay-filter="demo1">回退</button>
		    </div> 	    
		  </div>		
		</form>
     </div> 
