...
.workinfordiv ul li .saveconfig2{width:100%;height: 25px;line-height: 25px;text-align: center;background: #1E9FFF;color: #fff;cursor: pointer;}
		...
		<div class="rightpath">
			<div id="workinfordiv" class="workinfordiv">
				<ul>
					...
					<li style="float:right;margin-top:10px;margin-right:10px;width: 80px"><div class="saveconfig" style="display:none" onclick="saveinfors()">审&nbsp;&nbsp;核</div><div class="saveconfig2" style="display:none" onclick="saveinfors2()">回&nbsp;&nbsp;退</div></li>
				</ul>
			</div>
...
<script type="text/javascript">
	...
	function getworkslist(data){
		$.ajax({
			url:"getauditworkslist.do",
			type:"post",
			dataType:"json",
			data:{isimport:data,cgerId:cgerId,workstatus:workstatus},
	...
	function workinfors(data1,data2,data3){
		$.ajax({
			...
			if(data3==5){
				$(".saveconfig2").css("display","block");
				$(".saveconfig").css("display","none");
				}else{
					$(".saveconfig2").css("display","none");
