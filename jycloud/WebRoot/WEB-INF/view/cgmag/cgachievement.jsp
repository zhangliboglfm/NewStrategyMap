...
<link rel="stylesheet" href="css/calligraphy/cgachievement.css" type="text/css"></link>

<script type="text/javascript" src="layui/layui.js"></script>
<script type="text/javascript" src="layui/lay/modules/element.js"></script>
<script type="text/javascript" src="js/jquery-1.9.1.js"></script>
<script type="text/javascript" src="js/jquery.nicescroll.js"></script>
<script type="text/javascript" src="js/cgjs/cgachievement.js"></script>
...
<body>
	<div class="maindiv">
		<div class="layui-tab layui-tab-brief tabdiv" lay-filter="test">
			<div class="rightdiv">
				<i class="iconfont" onclick="download()"  title="下载文件">&#xe659;</i>
				<i class="iconfont" style="margin-left: 20px;" onclick="uplaod()"  title="上传文件">&#xe658;</i>
...
<script type="text/javascript">
	...
	$(function(){
		...
		if(jsptype=="audit"||auditStatus=="5"){
			$(".rightdiv").remove();
		}
		if(artname!="" && artname!="null" && artname!="undefined"){
			$("#ifrWord").attr("src","showcgachieveword.do?cgId="+cgId+"&wordName="+artname);
		}
		if(artpic!="" && artpic!="null" && artpic!="undefined"){
			...
			for (var a=0;a<strArr.length;a++) {
				str+="<img class='showImg' src='getCGImgStream.do?filename="+strArr[a]+"'></img>";
			}
			$("#showImgD").html("");
			$("#showImgD").html(str);
