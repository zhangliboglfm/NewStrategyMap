...
<link rel="stylesheet" href="css/cgmaininfo.css" type="text/css"></link>

<script type="text/javascript" src="layui/layui.all.js"></script>
<script type="text/javascript" src="layui/lay/modules/element.js"></script>
<script type="text/javascript" src="js/jquery-1.9.1.js"></script>
<script type="text/javascript" src="js/jquery.nicescroll.js"></script>
<script type="text/javascript" src="js/cgmaininfo.js"></script>
<style type="text/css">
...
var form = layui.form,laydate=layui.laydate,layer = layui.layer,laypage = layui.laypage,element=layui.element;
	$(function(){
		...
		$("#ifrCgList").attr("src","cginfolistAudit.do");
	});
	//调整页面布局
	function adjust(){
