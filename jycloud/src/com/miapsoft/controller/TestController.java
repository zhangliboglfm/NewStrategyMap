...
//		JSONArray result = testManager.getRegions();
	...
	@RequestMapping(value="testkb1.do")
	public String testkb1(HttpServletRequest request,HttpServletResponse response) {
		return "testkb1";
	}
	@ResponseBody
	@RequestMapping(value="testkb.do")
	public void testkb(HttpServletRequest request,HttpServletResponse response) {
		...
		try {
			for (int i = 0; i < 10; i++) {
				printWriter.print("adsadadasdads"+i);
				printWriter.print("<br>");
				System.out.println("adsadadasdads"+i);
				printWriter.flush();
				Thread.sleep(1000);
			}
		} catch (Exception e) {
