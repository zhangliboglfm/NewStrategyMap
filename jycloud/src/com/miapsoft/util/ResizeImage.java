...
public class ResizeImage {
     ...
     * @return              返回处理后的图像
     */
    public static BufferedImage resizeImageByHeight(BufferedImage im, float height) {
    	/*原始图像的宽度和高度*/
    	int oriwidth = im.getWidth();
    	int oriheight = im.getHeight();
    	
    	/*调整后的图片的宽度和高度*/
    	int toWidth = (int) (oriwidth*height/oriheight);
    ...
    */
     ...
     * @return
     */
    public static boolean SaveImg(BufferedImage im, String fileName) {
    	File f = new File(fileName);
    	String foldpath =f.getParent();
    ...
    */
    ...
    public static void main(String[] args) throws Exception{
        ...
        List<BufferedImage> imageList = ResizeImage.getImageList(inputFoler,new String[] {"jpg"});
        for(BufferedImage i : imageList) {
        	writeHighQuality(zoomImage(i,times),outputFolder);
  }
    }
}
